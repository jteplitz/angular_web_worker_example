// Type definitions for Angular v2.0.0-local_sha.29c46ea
...
declare module ngWorker {
   ...
   */
  function bootstrapWebWorker(appComponentType: Type, componentInjectableBindings?: List<Type | Binding | List<any>>) : Promise<ApplicationRef> ;
...
declare module ngUi {
  ...
  function spawnWebWorker(uri: string) : MessageBus ;
